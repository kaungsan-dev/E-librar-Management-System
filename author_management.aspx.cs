    ...
    public partial class author_management : System.Web.UI.Page
    {
        ...
        void deleteAuthor()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("DELETE from author_master_tbl WHERE author_id='" + TextBox9.Text.Trim() + "'", con);
        ...
        void updateAuthor()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE author_master_tbl SET author_name=@author_name WHERE author_id='"+TextBox9.Text.Trim()+"'", con);
        ...
        void addNewAuthor()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@author_id", TextBox9.Text.Trim());
                cmd.Parameters.AddWithValue("@author_name", TextBox1.Text.Trim());
        ...
        bool checkIfAuthorExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM author_master_tbl where " +
                    "author_id='" + TextBox9.Text.Trim() + "';", con);
