...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--Choice IMG to Change JS Script--%>
      ...
      <div class="row col-md-12">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" width="150px" src="imgs/book.PNG" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-4">
                        <asp:Button ID="Button1" class="btn btn-outline-success btn-sm btn-block" runat="server" Text="Add" OnClick="Button1_Click" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-outline-info btn-sm btn-block" runat="server" Text="Update" OnClick="Button3_Click" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-outline-danger btn-sm btn-block" runat="server" Text="Delete" OnClick="Button2_Click" />
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row col-md-12 container-fluid">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="book_id" DataSourceID="SqlDataSource1" Font-Bold="False">
                            <Columns>
